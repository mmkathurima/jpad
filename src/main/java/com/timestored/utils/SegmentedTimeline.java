...
public class SegmentedTimeline implements Timeline, Cloneable, Serializable {
     ...
     */
    private final Calendar workingCalendarNoDST;
     ...
     */
    private final Calendar workingCalendar = Calendar.getInstance();
    /**
     * Segment size in ms.
     */
