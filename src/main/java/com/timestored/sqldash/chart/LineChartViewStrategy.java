...
public class LineChartViewStrategy
    ...
    private LineChartViewStrategy() {
        super("Line Chart", DBIcons.CHART_LINE);
    }

    public UpdateableView getView(ChartTheme theme) {
        JFreeChart chart = ChartFactory.createLineChart("", "", "", null, PlotOrientation.VERTICAL, theme.showChartLegend(), true, false);
...
/* Location:              C:\Users\Admin\Downloads\jpad\jpad.jar!\com\timestored\sqldash\chart\LineChartViewStrategy.class
