...
public class ViewStrategyFactory {
    ...
    private static final List<ViewStrategy> STRATEGIES = Collections.unmodifiableList(Arrays.asList(TimeseriesViewStrategy.INSTANCE, AreaChartViewStrategy.INSTANCE, BarChartViewStrategy.INSTANCE, BubbleChartViewStrategy.INSTANCE, CandleStickViewStrategy.INSTANCE, DataTableViewStrategy.getInstance(false), HeatMapViewStrategy.INSTANCE, HistogramViewStrategy.INSTANCE, LineChartViewStrategy.INSTANCE, NoRedrawViewStrategy.INSTANCE, PieChartViewStrategy.INSTANCE, ScatterPlotViewStrategy.INSTANCE));
...
/* Location:              C:\Users\Admin\Downloads\jpad\jpad.jar!\com\timestored\sqldash\chart\ViewStrategyFactory.class
